...
let eliminateByMostCommon colNo (arr: int [,]) =
    eliminateBySelector getMostCommonByColumn colNo arr

let eliminateByLeastCommon colNo (arr: int [,]) =
    eliminateBySelector getLeastCommonByColumn colNo arr
